...
| **Coding agents used during build** | [`docs/coding_agents_evidence.md`](coding_agents_evidence.md) | Verified in repo | Screenshot evidence included; prompt log template provided. |
